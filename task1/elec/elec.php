    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-4 offset-4  mt-5">
                <form action="elec.php" method="POST">
                    <div class="form-group">
                        <label for="num1">your units </label>
                ...
                if ($_POST) {
                    $num1 = $_POST['num1'];
                    $sum='';
                    $additionalsurcharger='';

                    if ($num1 > 0 && $num1 <=50) {
                        $sum = $num1 * .5; 
                        echo "the cost is ".$sum ."LE";
                        $additionalsurcharger= $sum*.2;
                        echo "with additional surchager". $total= $additionalsurcharger+$sum ."LE";
